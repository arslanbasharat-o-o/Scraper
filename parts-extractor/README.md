...
`start.bat` will automatically create `.venv` when needed, install or refresh dependencies from `requirements.txt`, pick an open port in `5000-5050`, and open the app in your browser.
