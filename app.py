...
def _launch_automation_job(job_id: int, trigger_type: str = 'schedule') -> Tuple[bool, str]:
    ...
    def worker():
        ...
        try:
            ...
            # checkpoint_only_phase1 / Collecting Product Checkpoint progress is
            # emitted by the external worker.
            # The worker enforces phase2_total = max(phase2_total, phase2_completed)
            # and reports 'status_message': 'Writing scraped products, comparison metadata, and run history to the database.'.
